...
<div id="imprint">
    ...
    <h4><b>Für Fragen und Anregungen mailen Sie bitte unserem <a href="http://mrauser.net">Webmaster</a>.</b></h4>
    <hr />
    <ul style="padding-left: 0;">
        <li><b>Steuer Nr.:</b> 48050 / 30608</li>
        <li><b>Gerichtsstand:</b> Amtsgericht Maulbronn</li>
        <li><b>Gerichtsregister Nr.:</b> GR 71/02</li>
        <li><b>Vereinsregister Nr.:</b> VR 442</li>
        <li>
            <b>Bankverbindung 1:</b> Sparkasse Pforzheim
            <ul>
                <li><b>BLZ:</b> 666 500 85</li>
                <li><b>Kontonummer:</b> 969 435</li>
            </ul>
        </li>
        <li>
            <b>Bankverbindung 2:</b> Volksbank Pforzheim
            <ul>
                <li><b>BLZ:</b> 666 900 00</li>
                <li><b>Kontonummer:</b> 353 139 7</li>
            </ul>
        </li>
    </ul>
</div>
